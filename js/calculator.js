...
function calculateSum() {
  ...
  const websiteReseption = document.querySelector('#calculator-form-input-request input:checked'); 
  ...
  const websiteReseptionValue = convertReceptOptionToPrice(websiteReseption.value);
...
function convertReceptOptionToPrice(option) {
  if (option === 'yes') {
    return 500;
  }
  return 0;
